...
public class JDBCConnection {
    ...
    private String url = "jdbc:postgresql://dumbo.inf.h-brs.de:5432/sdzeut2s";

    private Connection conn;

    private String login = "sdzeut2s";

    private String password = "sdzeut2s";
    ...
    public void openConnection() throws DatabaseLayerException {
        ...
        try {
            ...
            props.setProperty("user", "sdzeut2s" );
            props.setProperty("password", "sdzeut2s" );
